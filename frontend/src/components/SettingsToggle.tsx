...
export default function SettingsToggle({ checked, disabled, label, onChange }: SettingsToggleProps) {
  return (
    <button
      ...
      className="relative h-5 w-9 shrink-0 cursor-pointer rounded-full transition-colors duration-150 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus-ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-panel)] disabled:cursor-not-allowed disabled:opacity-50"
